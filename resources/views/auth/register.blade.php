            ...
            <div class="content my-4">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="column flex-wrap justify-content-early">
                        <div class="column_el mr col-sm-12 col-md-auto ">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Nome') }}</label>
                            <input id="name" type="text"
                                class="form-control col-sm-12 col-md-5 @error('name') is-invalid @enderror" name="name"
                        ...
                        <div class="column_el col-sm-12 col-md-auto">
