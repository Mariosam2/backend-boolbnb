...
<div id="user_access">
    ...
    <div class="content">
        ...
        <div class="logo">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 162.89 25.84">
                <defs>
                    ...
                    <linearGradient id="Sfumatura_senza_nome_3" x1="22.29" y1="12.92" x2="67.58" y2="12.92" gradientUnits="userSpaceOnUse">
        ...
        <div class="links">
            ...
            <a class="nav-link on" href="{{ route('register') }}">{{ __('Register') }}</a>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <input type="date" name="birth_date" id="birth_date" class="form-control  @error('birth_date') is-invalid @enderror" placeholder="" value="{{ old('surname') }}" aria-describedby="helpId">
            @error('birth_date')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
