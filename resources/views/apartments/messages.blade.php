...
@section('content')
    <div class="col px-2 px-xl-5 flex-grow-1">
        <div class="container remove_scrollbar mx-auto ms-xl-3 spacing" style="height: 100vh; overflow-y:auto">
    ...
    <script type="module">
       const axios = window.axios;
        ...
        readAllBtn.addEventListener('click', function(){
            let url = 'http://127.0.0.1:8000/message/'+ 0 + '/'+ true;
            axios.put(url, { }, 
            {
                headers: {
        ...
        messages.forEach(message=>{
            message.addEventListener('click', function(){
                ...
                let url = 'http://127.0.0.1:8000/message/' + messageId + '/'+ false;
                console.log()
            axios.put(url, { }, 
            {
                headers: {
